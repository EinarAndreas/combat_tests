...
This <b>report</b> aims to show to what extent the use of ComBat led to false results in the second "proof of concept" analysis performed in Johnson et al. The example named "Data Set 2" and their analysis are described in the supplementary materials for Johnson et al.
