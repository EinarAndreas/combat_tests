...
#"sampledata/testdata_small.txt", "sampledata/sample_information_small.txt",  write=FALSE, skip=1

setwd("C:\\Users\\vegard2013\\Dropbox\\div\\jobb\\combat_test")

expression_xls = "sampledata/testdata_small.txt"
sample_info_file ="sampledata/sample_information_small.txt"


expression_xls = "sampledata/design_3x2_50-0_1-1_0-50_data.txt"
sample_info_file ="sampledata/design_3x2_50-0_1-1_0-50_sampleannotation.txt"
...
x = ComBat(expression_xls, sample_info_file,  skip=1, write=FALSE)
...
ComBat <- function(expression_xls, sample_info_file, type='txt', write=T, covariates='all', par.prior=T, filter=F, skip=0, prior.plots=T){
	...
	if (skip>0){
              ...
              dat <- dat[,-c(1:skip)]}  else{geneinfo=NULL}
        #print(geneinfo[1:4])
        #print(dat[1:2,])
