...
## Introduction
Ikke ferdig. notater
Molecular biololgy experiments chained of laboartory procedures. A change or perturbation in any of the sequenctial manufactoring or laboratory procedures generating measurments
 other effects than uncontrolled variables
related to the condition tested
(20838408)
'
"mean-centering and standardization methods may run the risk of distorting biological differences after removing batch effects." (20676067)
eksempler på batch effects
http://www.nature.com/tpj/journal/v10/n4/full/tpj201057a.html

Confounding variables have the potiential to mislead researcher to make reach wrong conclusions if left unaccounted for. In Molecular Biology confounding variables is often called "batch effects", probably due to the fact that reagents and microarray chips are made in batches, and this is frequently observed as an effect in the measurements. See 20676067 for more examples. 


For a typical microaray experiment comparing groups differences, a balanced group/batch design, batch effects will lower the statistical power, while for an unbalanced design it may in additon lead to an increase in false positve results.  In different field Nuisance Factor
Blocking in the statistical test
